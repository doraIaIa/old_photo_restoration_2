...
| Bảng tổng hợp controlled smoke experiments giúp chọn hướng thử tiếp theo | `results/registry/best_runs.md` | markdown | So sánh `r001`, `r002`, `r003`, `r004` trên cùng dataset |
